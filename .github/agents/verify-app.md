---
name: verify-app
description: Thoroughly test the application works correctly after changes. Runs static analysis, automated tests, and manual verification, then reports pass/fail with details.
permissionMode: auto
---
