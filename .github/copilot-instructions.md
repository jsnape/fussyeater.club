...
- Observability by default: when implementing new features, add or update meaningful logs/telemetry so runtime behavior and failures are diagnosable in production
