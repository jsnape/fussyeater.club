---
name: code-architect
description: Design reviews and architectural decisions. Evaluates proposed features for architectural fit, identifies scalability issues, and suggests design patterns.
---
