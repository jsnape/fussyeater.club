...
<main class="min-h-dvh bg-slate-50 px-6 py-10 md:px-10 md:py-16">
    <section class="mx-auto max-w-xl rounded-xl border border-slate-200 bg-white p-8 shadow-md">
        ...
        <form class="mt-6 space-y-6" onsubmit={submitRegistration}>
            <div>
                <label class="mb-1 block text-sm font-medium text-slate-900" for="name"
                    >Full name</label
                >
                <input
                    id="name"
            ...
            <fieldset class="space-y-3">
                <legend class="text-sm font-medium text-slate-900">Household</legend>
