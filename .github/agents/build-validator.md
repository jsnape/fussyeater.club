...
description: Ensure project builds correctly for deployment. Runs clean build, type checks, linting, and tests, then reports findings.
permissionMode: auto
---
...
rm -rf dist/ build/ .svelte-kit/ node_modules/.cache
